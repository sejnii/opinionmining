...
public class CommentHandling {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("1 : 단일분석, 2: 비교분석");
            Integer option = scan.nextInt();
            if(option==2)
            {
            	System.out.println("��ȣ��/��ǰ�� �Է�");
        			 ...
        			 String text = getText();
        	            ...
        	            if (videoComments.isEmpty()) {
        	                ...
        	                for (CommentThread videoComment : videoComments) {
        	                    ...
        	                    out_com.write(snippet.getTextDisplay());
        	                    out_com.newLine();
        	                    System.out.println("\n-------------------------------------------------------------\n");
            ...
            JavaRDD<String> textLoadRDD = ctx.textFile("C:\\Users\\����\\eclipse-workspace\\youtube\\out.txt");
